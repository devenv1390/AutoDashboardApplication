...
import com.qky.autodashboardapplication.util.EdgeTransparentViewUtils;

/**
 * EdgeTransparentView class
 *
 * @author kaiyuan.qin
 * @date 2024/3/13
 */
public class EdgeTransparentView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        drawSize = typedArray.getDimension(R.styleable.EdgeTransparentView_edge_width, EdgeTransparentViewUtils.d2p(getContext(), 20));
        typedArray.recycle();
    }
